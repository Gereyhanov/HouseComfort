...
public class BluetoothLeUartAdapter extends BluetoothGattCallback implements BluetoothAdapter.LeScanCallback{
    ...
    public interface Callback {
        public void onConnected(BluetoothLeUartAdapter uart);
        public void onConnectFailed(BluetoothLeUartAdapter uart);
        public void onDisconnected(BluetoothLeUartAdapter uart);
        public void onReceive(BluetoothLeUartAdapter uart, BluetoothGattCharacteristic rx);
        public void onDeviceFound(BluetoothDevice device);
        public void onDeviceInfoAvailable();
    }

    public BluetoothLeUartAdapter(Context context) {
        super();
    ...
    private void notifyOnConnected(BluetoothLeUartAdapter uart) {
    ...
    private void notifyOnConnectFailed(BluetoothLeUartAdapter uart) {
        for (Callback cb : callbacks.keySet()) {
            if (cb != null) {
    ...
    private void notifyOnDisconnected(BluetoothLeUartAdapter uart) {
        for (Callback cb : callbacks.keySet()) {
            if (cb != null) {
    ...
    private void notifyOnReceive(BluetoothLeUartAdapter uart, BluetoothGattCharacteristic rx) {
        for (Callback cb : callbacks.keySet()) {
            if (cb != null ) {
